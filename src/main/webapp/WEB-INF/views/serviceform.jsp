...
<div class="serviceform">
	...
	<div class="main-content"
		...
		<form:form action="addServiceOfficer" id="serviceform"
			...
			<div class="form-group">
				...
				<!-- 				                        </svg> -->
				<!-- 		                        <label  style="margin-left:5px;line-height:11px">Currently Active</label> -->
				<!-- 		                      </div> -->
				<!-- 	                    	</div> -->
				<!--                    		 </div> -->
				...
				<!-- 		                          </div> -->
				<!-- 		                        </div> -->
				<!-- 		                        <input type="text" class="form-control form-control-sm datepicker" name="" id=""> -->
				<!-- 		                      </div> -->
				<!-- 		           		</div> -->
			</div>
...
<script src="resources/assets/js/serviceofficer.js"></script>
