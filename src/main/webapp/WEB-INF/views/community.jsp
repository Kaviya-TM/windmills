...
<div class="propertyform">
	...
	<div class="main-content"
		...
		<form:form action="addCommunity" id="" modelAttribute="property">
			...
			<div class="form-group">
				...
				<div class="communityholder">
					<label class="communitylabel">Sub Community</label> <input
						type="text" class="form-control form-control-sm communitytext"
						name="subCommunity" id="" placeholder="Sub Community">
				</div>
				<div class="communityholder">
