...
<div class="main-sidebar sidebar-style-2" tabindex="1"
	...
	<aside id="sidebar-wrapper">
		...
		<ul class="sidebar-menu">
			...
			<li class="dropdown" style="margin-top: 30px"><a
			...
			<li class="dropdown"><a
				href="<c:url value="sold-transactions"/>" class="nav-link"><svg
						xmlns="http://www.w3.org/2000/svg" width="24" height="24"
						viewBox="0 0 24 24" fill="none" stroke="currentColor"
						stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
						class="feather feather-monitor">
						<rect x="2" y="3" width="20" height="14" rx="2" ry="2"></rect>
						<line x1="8" y1="21" x2="16" y2="21"></line>
						<line x1="12" y1="17" x2="12" y2="21"></line></svg><span>Sold Transactions</span></a>
			</li>
			<li class="dropdown"><a href="#"
				class="menu-toggle nav-link has-dropdown"><svg
						xmlns="http://www.w3.org/2000/svg" width="24" height="24"
