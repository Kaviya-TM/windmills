<div class="form-group documents">
				...
				<div class="valuationholder d1">
					<input type="text" class="labelholder"
					  ...
					  <div class="pretty p-svg p-curve" style="float:left;color: black;margin-top:4px;margin-right:60px;">
							<input type="checkbox" id="no1" name="" value="">
							<div class="state p-success">
								<svg class="svg svg-icon" viewBox="0 0 20 20">
					                <path d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z"
									style="stroke: white;fill:white;"></path>
					...
					<label for="document1" class="custom-file-upload firstblock"> <i
						class="fa fa-cloud-upload"></i>Upload
					</label> <input id="document1" name='files[0]' type="file"
						style="display: none;">
				</div>
				...
				<div class="valuationholder d2">
					<input type="text" class="labelholder"
					  ...
					  <div class="pretty p-svg p-curve" style="float:left;color: black;margin-top:4px;margin-right:60px;">
							<input type="checkbox" id="no2" name="" value="">
							<div class="state p-success">
								<svg class="svg svg-icon" viewBox="0 0 20 20">
					                <path d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z"
									style="stroke: white;fill:white;"></path>
					...
					<label for="document2" class="custom-file-upload secondblock"> <i
						class="fa fa-cloud-upload"></i>Upload
					</label> <input id="document2" name='files[1]' type="file"
						style="display: none;">
				</div>
				...
				<div class="valuationholder d3">
					<input type="text" class="labelholder"
					  ...
					  <div class="pretty p-svg p-curve" style="float:left;color: black;margin-top:4px;margin-right:60px;">
							<input type="checkbox" id="no3" name="" value="">
							<div class="state p-success">
								<svg class="svg svg-icon" viewBox="0 0 20 20">
					                <path d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z"
									style="stroke: white;fill:white;"></path>
					...
					<label for="document3" class="custom-file-upload thirdblock"> <i
						class="fa fa-cloud-upload"></i>Upload
					</label> <input id="document3" name='files[1]' type="file"
						style="display: none;">
				</div>
				...
				<div class="valuationholder d4">
					<input type="text" class="labelholder"
					  ...
					  <div class="pretty p-svg p-curve" style="float:left;color: black;margin-top:4px;margin-right:60px;">
							<input type="checkbox" id="no4" name="" value="">
							<div class="state p-success">
								<svg class="svg svg-icon" viewBox="0 0 20 20">
					                <path d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z"
									style="stroke: white;fill:white;"></path>
					...
					<label for="document4" class="custom-file-upload fourthblock"> <i
						class="fa fa-cloud-upload"></i>Upload
					</label> <input id="document4" name='files[1]' type="file"
						style="display: none;">
				</div>
				...
				<div class="valuationholder d5">
					<input type="text" class="labelholder"
					  ...
					  <div class="pretty p-svg p-curve" style="float:left;color: black;margin-top:4px;margin-right:60px;">
							<input type="checkbox" id="no5" name="" value="">
							<div class="state p-success">
								<svg class="svg svg-icon" viewBox="0 0 20 20">
					                <path d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z"
									style="stroke: white;fill:white;"></path>
					...
					<label for="document5" class="custom-file-upload fifthblock"> <i
						class="fa fa-cloud-upload"></i>Upload
					</label> <input id="document5" name='files[1]' type="file"
						style="display: none;">
				</div>
				...
				<div class="valuationholder d6">
					<input type="text" class="labelholder"
					  ...
					  <div class="pretty p-svg p-curve" style="float:left;color: black;margin-top:4px;margin-right:60px;">
							<input type="checkbox" id="no6" name="" value="">
							<div class="state p-success">
								<svg class="svg svg-icon" viewBox="0 0 20 20">
					                <path d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z"
									style="stroke: white;fill:white;"></path>
					...
					<label for="document6" class="custom-file-upload sixthblock"> <i
						class="fa fa-cloud-upload"></i>Upload
					</label> <input id="document6" name='files[1]' type="file"
						style="display: none;">
				</div>
				...
				<div class="valuationholder d7">
					<input type="text" class="labelholder"
					  ...
					  <div class="pretty p-svg p-curve" style="float:left;color: black;margin-top:4px;margin-right:60px;">
							<input type="checkbox" id="no7" name="" value="">
							<div class="state p-success">
								<svg class="svg svg-icon" viewBox="0 0 20 20">
					                <path d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z"
									style="stroke: white;fill:white;"></path>
					...
					<label for="document7" class="custom-file-upload sevenblock"> <i
						class="fa fa-cloud-upload"></i>Upload
					</label> <input id="document7" name='files[1]' type="file"
						style="display: none;">
				</div>
				...
				<div class="valuationholder d8">
					<input type="text" class="labelholder"
					  ...
					  <div class="pretty p-svg p-curve" style="float:left;color: black;margin-top:4px;margin-right:60px;">
							<input type="checkbox" id="no8" name="" value="">
							<div class="state p-success">
								<svg class="svg svg-icon" viewBox="0 0 20 20">
					                <path d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z"
									style="stroke: white;fill:white;"></path>
					...
					<label for="document8" class="custom-file-upload eightblock"> <i
						class="fa fa-cloud-upload"></i>Upload
					</label> <input id="document8" name='files[1]' type="file"
						style="display: none;">
				</div>
				...
				<div class="valuationholder d9">
					<input type="text" class="labelholder"
					  ...
					  <div class="pretty p-svg p-curve" style="float:left;color: black;margin-top:4px;margin-right:60px;">
							<input type="checkbox" id="no9" name="" value="">
							<div class="state p-success">
								<svg class="svg svg-icon" viewBox="0 0 20 20">
					                <path d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z"
									style="stroke: white;fill:white;"></path>
					...
					<label for="document9" class="custom-file-upload nineblock"> <i
						class="fa fa-cloud-upload"></i>Upload
				...
				<div class="valuationholder d10">
					<input type="text" class="labelholder"
					  ...
					  <div class="pretty p-svg p-curve" style="float:left;color: black;margin-top:4px;margin-right:60px;">
							<input type="checkbox" id="no10" name="" value="">
							<div class="state p-success">
								<svg class="svg svg-icon" viewBox="0 0 20 20">
					                <path d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z"
									style="stroke: white;fill:white;"></path>
					...
					<label for="document10" class="custom-file-upload tenblock"> <i
						class="fa fa-cloud-upload"></i>Upload
